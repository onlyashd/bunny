...
class AquaTheme {
    private val primaryLight = Color(0xFF096B5A)
    private val onPrimaryLight = Color(0xFFFFFFFF)
    private val primaryContainerLight = Color(0xFFA1F2DC)
    private val onPrimaryContainerLight = Color(0xFF005143)
    private val secondaryLight = Color(0xFF4B635C)
    private val onSecondaryLight = Color(0xFFFFFFFF)
    private val secondaryContainerLight = Color(0xFFCDE8DF)
    private val onSecondaryContainerLight = Color(0xFF334B45)
    private val tertiaryLight = Color(0xFF426278)
    private val onTertiaryLight = Color(0xFFFFFFFF)
    private val tertiaryContainerLight = Color(0xFFC7E7FF)
    private val onTertiaryContainerLight = Color(0xFF2A4A5F)
    ...
    private val inversePrimaryLight = Color(0xFF85D6C1)
    ...
    private val primaryDark = Color(0xFF85D6C1)
    private val onPrimaryDark = Color(0xFF00382E)
    private val primaryContainerDark = Color(0xFF005143)
    private val onPrimaryContainerDark = Color(0xFFA1F2DC)
    private val secondaryDark = Color(0xFFB1CCC3)
    private val onSecondaryDark = Color(0xFF1D352F)
    private val secondaryContainerDark = Color(0xFF334B45)
    private val onSecondaryContainerDark = Color(0xFFCDE8DF)
    private val tertiaryDark = Color(0xFFAACBE3)
    private val onTertiaryDark = Color(0xFF103447)
    private val tertiaryContainerDark = Color(0xFF2A4A5F)
    private val onTertiaryContainerDark = Color(0xFFC7E7FF)
    ...
    private val inversePrimaryDark = Color(0xFF096B5A)
    ...
    companion object {
        val lightScheme = AquaTheme().lightScheme
        val darkScheme = AquaTheme().darkScheme
        val sample = AquaTheme().primaryLight
    }
}